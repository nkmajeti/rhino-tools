...
{
    [TestFixture]
    public class ClassInjectionTests
    {
        ...
        {
            Assert.IsNotNull(IoC.Resolve(typeof(IRepository<>).MakeGenericType(typeof(Model.User))));
        }
        ...
        public void Shoud_find_user_using_get()
        {
            ...
            Assert.IsTrue(IoC.Resolve<Controller.UserControllerUsingClass>().FoundUser);
        }
        ...
        public void Shoud_find_user_using_fetching_strategy()
        {
            ...
            IoC.Container.AddComponent<IFetchingStrategy<Model.User>, Model.StrategyForClass>();
            Assert.IsTrue(IoC.Resolve<Controller.UserControllerUsingClass>().FoundUser);
        }
    }
}
